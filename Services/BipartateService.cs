...
{
    public class BipartateService : IBipartateService
    {
        private Dictionary<Vertex, List<Vertex>> _adjacencyList;
        private ApplicationDbContext _context;
        private Dictionary<Guid, Guid> matchings = new Dictionary<Guid, Guid>();
        public Dictionary<Guid, Guid> ConfigureBipartateGraph(List<Employee> employees, List<Tasks> tasks, ApplicationDbContext context)
        {
            _context = context;
